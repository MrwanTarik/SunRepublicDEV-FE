  ...
  return (
    <div
      className={classNames(
        classes.hero,
        `flex flex-col gap-y-[60px] lg:gap-y-[65px] pt-[25px] md:pt-[40px] lg:pt-[65px]`
      )}
    >
      <div className="container flex flex-col lg:flex-row gap-x-0 lg:gap-x-[71px] gap-y-[30px] lg:gap-y-0 ">
        <div className="w-full lg:w-[68.5%] pt-[0] lg:pt-[26px]">
          ...
          <p className="pt-[10px] lg:pt-[18px] text-[white] text-[24px] font-extrabold lg:text-[36px] leading-[30px] lg:leading-[46px]">
            <span className="ps-[5px] lg:ps-[10px] ">-</span> {t('heroHeader')}
          </p>
      ...
      <div className="lg:border-t border-[rgba(255,255,255,0.4)]">
        <div className="flex flex-col lg:flex-row ">
          <div className="lg:border-r flex-1 border-[rgba(255,255,255,0.4)] flex flex-col items-center lg:items-start lg:gap-y-[25px] gap-y-[20px] text-center lg:text-start lg:ps-[70px] xl:ps-[90px]">
